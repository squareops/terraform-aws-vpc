...
- **vpc-with-ipv6:** To create VPC with IPv6 support just you have to enable the parameter ipv6_enabled. Rest all the things will be taken care by module. Refer for example `vpc-with-ipv6`. Refer [Peering Docs](https://github.com/Ad-squareops/terraform-aws-vpc/tree/main/examples/vpc-with-ipv6) for more information
